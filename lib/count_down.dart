...
import 'package:mini/util/design/color_list.dart';

// ignore: prefer_generic_function_type_aliases
typedef Widget DigitBuilder(context, digit);

///
/// A [Widget] provides a simple implementation of a CounDown using [FlipPanelPlus]
///
// ignore: must_be_immutable
class CounDown extends StatelessWidget {
  ...
  /// custom str label that you can change them when we use [CounDown.reverseCountdown]
  ...
  CounDown.countdown({
    ...
    _digitBuilder = (context, digit) => Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: borderRadius,
        border: Border.all(
          width: 2,color: ton_text_color.withOpacity(0.6)
        )
      ),
      child: Text(
        '$digit',
