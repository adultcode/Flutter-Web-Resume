    ...
    var col=  Column(
      children: <Widget>[
        ...
        Container(
          ...
          child: Text('Hesam ',style: name_style,),

        ),
        Container(
            margin: const EdgeInsets.only(top:10.0),
            //  width: 200.0,
            child: Text('Mobile Developer',style:developer_style)
        ),
        row_social,
          ...
          child: Row(
            ...
            children: <Widget>[
              Container(
                  ...
                  child: InkWell(
                    child: Text_Icon('Download resume','img/download.svg'),
                    onTap: (){
              ...
              Container(
                ...
                child: InkWell(onTap: (){
                  _launchURL('https://t.me/');
                    ...
                    child: Text_Icon('Contact me','img/telegram.svg')),
              ),
            ],
          ),
        )
